...
* Go to <https://github.com/adobe/au-gov-designsystem/releases/latest> and download `au-gov-designsystem-{version}.zip`
* Upload `au-gov-designsystem-{version}.zip` in AEMaaCS's site creation wizard to create a new site from that template.

## Build locally

Alternatively you can build `au-gov-designsystem-{version}.zip` locally.
...
1. The site template ZIP file is now located below the template root: `au-gov-designsystem-{version}.zip`.
...
* Commit, build and release latest Site Theme related changes in [Site Theme E2E Repo](https://github.com/adobe/au-gov-designsystem-theme-e2e).
